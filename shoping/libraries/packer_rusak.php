...
class Packer {
	...
	protected function _checkIt($newName,$newPacked,$newPackage,$path,$combine = FALSE)
	{				
	...
	protected function _parseIt($path)
	{
		...
		return $this->_checkIt($newName,$newPacked,$newPackage,$path); // return the new path or the old path
	}
